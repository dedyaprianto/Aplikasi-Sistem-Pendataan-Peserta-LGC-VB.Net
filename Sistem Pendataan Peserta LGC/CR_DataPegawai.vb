...
Public Class CR_DataPegawai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Pendataan_Peserta_LGC.CR_DataPegawai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DataPegawai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DataPegawai = New CR_DataPegawai()
        rpt.Site = Me.Site
        Return rpt
    End Function
