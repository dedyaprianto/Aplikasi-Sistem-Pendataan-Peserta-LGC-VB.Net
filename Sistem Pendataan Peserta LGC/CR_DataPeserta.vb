...
Public Class CR_DataPeserta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistem_Pendataan_Peserta_LGC.CR_DataPeserta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DataPeserta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DataPeserta = New CR_DataPeserta()
        rpt.Site = Me.Site
        Return rpt
    End Function
